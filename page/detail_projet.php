           ...
           <div class="col-md-2">   </div>
                 <div class="col-lg-8 col-md-8  col-sm-6 col-xs-12">
                    <div class="card">
                     ...
                     <h4 style="color: red" > Le jour d'envoie du fichier <span style="color: green;"><?php echo html_entity_decode($roww['Nom_F']); ?></span> est  chaque :</h4>
                      <?php
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        ?>
                            <h2 >
                             <span style="color: green;"><b><u>Nom de projet :</u></b></span> <span style="color: red;"> <?php echo $row['Nom_Pro'];?> </span>
                            </h2>
                     <h2 >
                            ...
                            <div class="table-responsive">
                               <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <?php
                                       ...
                                       <td><a href="detail_projet.php?id=<?php echo$_GET['id']?>&id_f=<?php echo $row["Id_fichier"]; ?>"  class="btn btn-warning"><i class="material-icons"  data-toggle="tooltip" title="details">&#xe3c8;</i></a></td>

                                        <td> <?php if ($_SESSION['id_role']=='2' OR $_SESSION['id_role']=='3' OR $_SESSION['id_role']=='1'){ ?>
                                          ...
                                          <?php if ($_SESSION['id_role']=='3'  OR $_SESSION['id_role']=='1'){ ?>
                                                 <td>    <a  class="btn btn-danger delete_btn" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a></td>
                                             <?php } ?>
