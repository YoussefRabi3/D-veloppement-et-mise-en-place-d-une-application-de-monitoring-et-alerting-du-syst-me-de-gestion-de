...
if (isset($_POST['ajouterprojet'])) 
{
  $planning = $_POST['pl'];
    ...
    $id_Pro = strip_tags(htmlentities(addslashes($_POST['id_Pro'])));

    
    $req_insert = "INSERT INTO `fichier`( `Nom_F`, `date_creation`,`id_Pro`,`planning`) VALUES ('$Nom_F', '$date_creation','$id_Pro',' $p')";
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>Procedure d'ajoute de fichier</h2>
                            ...
                            <form id="wizard_with_validation" method="POST">
                                ...
                                <fieldset>
                                     <div  class="form-group form-float">
                                        <div class="form-line">
                                            <select name="id_Pro" id="pet-select" style="width: 1067px; height: 25px;">
            ...
            <?php } ?>
                                ...
                                <input style="display:block;" class="btn btn-success" href="detail_projet.php?id=<?php echo $row["id_Pro"]; ?>" class="btn btn-danger" id="sub" name="ajouterprojet" type="submit" > 
                            </div>
                        </div>
                    </div>
                </div>
