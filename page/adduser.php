                ...
                <tbody>
                    ...
                    <tr>
                       <td><?php echo $row["id_Pro"]; ?></td>
                         ...
                         <td> 
                         		<a class="add" title="Add" data-toggle="tooltip" href="adduser.php?id=<?php echo $row["id_Pro"]; ?>"><i class="material-icons">&#xE03B;</i></a>
	                            <a class="edit" title="Edit" data-toggle="tooltip" href="#?id=<?php echo $row["id_Pro"]; ?>"><i class="material-icons">&#xE254;</i></a>
	                            <a class="delete" title="Delete" data-toggle="tooltip" href="adduser.php?id=<?php echo $row["id_Pro"]; ?>"><i class="material-icons">&#xE872;</i></a>
                         </td>                               
                        </td>
                    </tr>
                <?php
