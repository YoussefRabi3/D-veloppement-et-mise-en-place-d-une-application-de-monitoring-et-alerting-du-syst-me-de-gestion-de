...
if (isset($_POST['ajouterprojet'])) 
{
  $planning = $_POST['pl'];
    ...
    $req_insert = "INSERT INTO `fichier`( `Nom_F`, `date_creation`,`id_Pro`,`planning`) VALUES ('$Nom_F', '$date_creation','$id',' $p')";
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <?php } ?>
                                ...
                                <input style="display:block;" class="btn btn-success" href="detail_projet.php?id=<?php echo $row["Id_fichier"]; ?>" class="btn btn-danger" id="sub" name="ajouterprojet" type="submit" > 
                            </div>
                        </div>
                    </div>
                </div>
